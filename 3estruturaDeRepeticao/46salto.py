...
while(nomeAtleta != ""):
    ...
    if(nomeAtleta != ""):
        ...
        somaSaltos = primeiroSalto + segundoSalto + terceiroSalto + quartoSalto + quintoSalto
        
        if((primeiroSalto >= segundoSalto) and (primeiroSalto >= terceiroSalto) and (primeiroSalto >= quartoSalto) and (primeiroSalto >= quintoSalto)):
        ...
        print("Melhor Salto: {} m".format(melhorSalto))
        print("Pior Salto: {} m".format(piorSalto))
        print("Media dos demais saltos: {}".format(somaSaltos / 3.0)

        print("Resultado Final: ")
        print("{0}: {1} m".format(nomeAtleta, (somaSaltos / 3.0))
