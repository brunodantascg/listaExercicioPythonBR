...
while (salarioFuncionario != 0):
    salarioFuncionario = float(input("Salário: "))
...
for salario in salarios:
    ...
    if ('maiorAbono' not in vars()) or (abono > maiorAbono):
        maiorAbono = abono
    print("R$ {0}\tR${1}".format(salario, abono))

print("Foram processados {0} votos".format(len(salarios))
print("Total gasto com abonos: {0}".format(totalAbono))
print("Valor minimo pago a {0} colaboradores".format(totalPiso))
print("Maior valor de abono pago: {0}".format(maiorAbono))
